...
For v2.0.3, upload **all files**, including the complete `tests` folder. Confirm that GitHub shows these four test files before redeploying:
...
Extract `alpaca_dip_reversal_trigger_lab_v2.0.3.zip`.
...
2. Upload everything inside the extracted v2.0.3 folder.
